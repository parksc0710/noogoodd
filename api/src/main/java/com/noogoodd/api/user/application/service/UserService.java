...
public class UserService implements GetUserUseCase, SetUserUserCase {
    ...
    public UserDto getUserById(Long id) {
        ...
        if (userEntity.isPresent()) {
            ...
            return new UserDto(entity.getId(), entity.getEmail(), entity.getPassword(), entity.getRole(), entity.getUuid(), entity.getNickname(), entity.isDisability_yn(), entity.getDisability_type(), entity.getAid_type(), entity.getAddress_area(), entity.getGender(), entity.getBirth_day(), entity.getSign_type(), entity.isAct_flg(), entity.getReg_dt(), entity.getChg_dt());
        } else {
    ...
    public UserDto registerUser(UserDto userDto) {
        User user = new User(userDto.getId(), userDto.getEmail(), userDto.getPassword(), userDto.getRole(), userDto.getUuid(), userDto.getNickname(), userDto.isDisability_yn(), userDto.getDisability_type(), userDto.getAid_type(), userDto.getAddress_area(), userDto.getGender(), userDto.getBirth_day(), userDto.getSign_type(), userDto.isAct_flg(), userDto.getReg_dt(), userDto.getChg_dt());
        UserEntity userEntity = new UserEntity(user.getId(), user.getEmail(), passwordEncoder.encode(user.getPassword()), user.getRole(), user.getUuid(), user.getNickname(), user.isDisability_yn(), user.getDisability_type(), user.getAid_type(), user.getAddress_area(), user.getGender(), user.getBirth_day(), user.getSign_type(), user.isAct_flg(), user.getReg_dt(), user.getChg_dt());
        UserEntity savedUser = userRepository.save(userEntity);
        return new UserDto(savedUser.getId(), savedUser.getEmail(), savedUser.getPassword(), savedUser.getRole(), savedUser.getUuid(), savedUser.getNickname(), savedUser.isDisability_yn(), savedUser.getDisability_type(), savedUser.getAid_type(), savedUser.getAddress_area(), savedUser.getGender(), savedUser.getBirth_day(), savedUser.getSign_type(), savedUser.isAct_flg(), savedUser.getReg_dt(), savedUser.getChg_dt());
    }
    ...
    public UserDto updateUser(Long id, UserDto afterDto) {
        ...
        if (userEntityOptional.isPresent()) {
            ...
            return new UserDto(updatedUser.getId(), updatedUser.getEmail(), passwordEncoder.encode(updatedUser.getPassword()), updatedUser.getRole(), updatedUser.getUuid(), updatedUser.getNickname(), updatedUser.isDisability_yn(), updatedUser.getDisability_type(), updatedUser.getAid_type(), updatedUser.getAddress_area(), updatedUser.getGender(), updatedUser.getBirth_day(), updatedUser.getSign_type(), updatedUser.isAct_flg(), updatedUser.getReg_dt(), updatedUser.getChg_dt());
        } else {
            throw new RuntimeException("User not found");
        }
    }
